...
byte MQTT_CONCENT_package[] = {0x10,  // Fixed Header
                               ...
                               (byte)'_', (byte)random(48, 122), (byte)random(48, 122), (byte)random(48, 122)
                              }; // MQTT 連線用封包


byte MQTT_Test_package[] = {0x30,  // Fixed Header
                            0x29,  // RL: 41 (Remaining Length)
                            0x00, 0x1B,                                               // Topic Length: 27
                            (byte)'L', (byte)'A',  (byte)'S',  (byte)'S', (byte)'/',  // Topic: LASS/TEST/WaterBox_tw/array
                            (byte)'T', (byte)'E',  (byte)'S',  (byte)'T', (byte)'/',
                            (byte)'W', (byte)'a',  (byte)'t',  (byte)'e', (byte)'r',
                            (byte)'B', (byte)'o',  (byte)'x',  (byte)'_', (byte)'T',
                            (byte)'W', (byte)'/',  (byte)'a',  (byte)'r', (byte)'r', (byte)'a', (byte)'y',
